                ...
                <div class="well well-sm">
                    <form class="form-horizontal" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="nombre_universidad" class=etiqueta_control>Teléfono</label>
                            ...
                            <div>
                            <label for="nombre_universidad" class=etiqueta_control>Estado</label>
                                <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-address-card-o"></i></span>
                                        <select id="estado" name="estado"></select>
                            </div>

                            <div class="form-group">
                            <label for="nombre_universidad" class=etiqueta_control>Municipio</label>
                            ...
                            <div class="form-group">
                            <label for="nombre_universidad" class=etiqueta_control>Descripción</label>
